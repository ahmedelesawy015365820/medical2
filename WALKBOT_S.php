  ...
  <div class="carousel-inner">
    <div class="carousel-item item active">
      <div class="row justify-content-center align-items-center" style="height: 100%;">
        <img src="image/product/WALKBOT_S/1.jpg" width="400px" height="250px">
      </div>
    </div>
    <div class="carousel-item item ">
      <div class="row justify-content-center align-items-center" style="height: 100%;">
        <img src="image/product/WALKBOT_S/2.jpg" width="400px" height="250px">
      </div>
    </div>
    <div class="carousel-item item ">
      <div class="row justify-content-center align-items-center" style="height: 100%;">
        <img src="image/product/WALKBOT_S/3.jpg" width="400px" height="250px">
      </div>
    </div>
    <div class="carousel-item item ">
      <div class="row justify-content-center align-items-center" style="height: 100%;">
        <img src="image/product/WALKBOT_S/4.jpg" width="400px" height="250px">
      </div>
    </div>
    <div class="carousel-item item ">
      <div class="row justify-content-center align-items-center" style="height: 100%;">
        <img src="image/product/WALKBOT_S/5.jpg" width="400px" height="250px">
      </div>
    </div>
    <div class="carousel-item item ">
      <div class="row justify-content-center align-items-center" style="height: 100%;">
        <img src="image/product/WALKBOT_S/6.png" width="400px" height="350px">
      </div>
    </div>
  </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 wow slideInRight" data-wow-duration="1s" data-wow-delay=".5s">
            <div class="enplusblue-img row 	justify-content-center">
              <img class="img-thumbnail" src="image/product/WALKBOT_S/2.jpg" width="450px" height="350px" alt="about">
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container wow zoomIn" data-wow-duration="1.5s" data-wow-delay="1s">
    ...
    <div class="row info">
      <div class="col-md-6">
        ...
        <p>140 - 200 cm</p>
        <h4>leg length (hip-knee)</h4>
        <p>350 - 480 mm</p>
        <h4>leg length (knee-ankle)</h4>
        <p>353 - 483 mm</p>
        <h4>dimensions </h4>
        <p>390 * 168 * 257 cm</p>
      ...
      <div class="col-lg-6">
        <div class="embed-responsive embed-responsive-21by9 video">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/1mIQxGuxRJ8" 
      ...
      <div class="col-lg-6">
        <div class="embed-responsive embed-responsive-21by9 video">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Op132yjbSu0" 
            title="YouTube video player" 
            frameborder="0" 
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
            allowfullscreen>
